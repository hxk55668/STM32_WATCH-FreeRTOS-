...
/**
 * @brief  Initializes the GPIO pins for power control and charge detection.
 * @Note   TPS63020    PA3连接电源控制引脚
 * @Note   TP4056M充电 PA2连接充电检测引脚
 */
...
/**
 * @brief  Reads the battery voltage using ADC.采集8次取平均值
 * @param  None
 * @retval Battery voltage in volts.
 * @Note   ADC通道1连接电池电压采集引脚
 */
